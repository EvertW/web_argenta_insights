                    ...
                    data.map(row => {
                            return <div className="flex flex-wrap justify-between py-4">
                                <div className="flex flex-row justify-between w-full">
                                    ...
                                    <span className="font-bold min-w-fit">{formatAmount(row.amount, prefixed)} {t('currency')}</span>
                                </div>
            ...
            React.Children.toArray(
                data.map(transaction => {
                    return <div className="flex flex-wrap justify-between py-4">
                        ...
                        <span className="font-bold">{formatAmount(parseAmount(transaction.amount), true)} {t('currency')}</span>
